...
#setwd('./FigureS1C_NPS_within_r_pain_rating')
file = 'NPS_within_r_pain.csv'
...
p<-ggplot(my_data,aes(x=study,y=within_r_pain, colour = col)) + geom_hline(yintercept=0,size=0.5,linetype = "dashed")

...
#setwd('./FigureS2A_Effect_size_NPS_mean_response')
file = 'NPS_local_mean_response_effect_size.csv'
...
Org <- order_data %>% gather(brain, d, nps:neg_lSTS)
Org$brain <- factor(Org$brain, level = c("nps","pos_rIns","pos_rdpIns","pos_rS2","pos_lIns","pos_dACC","pos_rThal","pos_vermis","pos_rV1","neg_rIPL","neg_pgACC","neg_PCC","neg_lLOC","neg_rpLOC","neg_rLOC","neg_lSTS"))

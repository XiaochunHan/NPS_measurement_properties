...
clearvars -except NPScorr SIIPScorr TEMP local_NPS_all_events_by_region local_SIIPS_all_events_by_region NPScorr_d_by_study nps_posnames nps_negnames siips_posnames siips_negnames figsavedir;
%% NPS correlation with TEMP
dfun = @(x) mean(x) ./ std(x);

figname = 'NPS local regions correlation with TEMP';
X = TEMP;
...
%% SIIPS correlation with TEMP
clearvars -except SIIPScorr TEMP local_SIIPS_all_events_by_region siips_posnames siips_negnames figsavedir dfun;

figname = 'SIIPS local regions correlation with TEMP';
X = TEMP;

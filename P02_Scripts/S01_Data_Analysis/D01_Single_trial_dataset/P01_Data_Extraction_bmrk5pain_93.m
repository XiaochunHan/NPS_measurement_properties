clear;clc;
Path = '/Volumes/Dart_Drop/Backup/NPS_Reliability/D01_Single_trial_dataset/canlab_single_trials_for_git_repo';
% st_datasets = {'nsf','bmrk3pain','bmrk3warm','bmrk4','bmrk5pain',...
%     'bmrk5snd','remi','scebl','ie2','ie','exp','levoderm',...
%     'romantic','ilcp','stephan'};
addpath(genpath('/Volumes/Dart_Drop/Backup/Research/canlab_single_trials'));
st_datasets = {'bmrk5pain','bmrk3pain','bmrk4','scebl','ie2','exp','ilcp','ie'};
%%
all_data = [];
...
cd(Path);
save('metadata_all_NPS_complete_exclude_nsf_bmrk5pain_93','all_data');
% clear meta_data s;

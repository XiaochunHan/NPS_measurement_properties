...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_within_r_temp_exclude_nsf.csv'
...
tiff("NPS_within_r_temp_exclude_nsf.tiff",units="in",width = 8,height = 5,res = 300)

...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_local_within_pain_effect_size.csv'
...
Org$brain <- factor(Org$brain, level = c("NPS","dACC","rIns","lIns","rdpIns","rS2","rThal","vermis","rV1","rIPL","pgACC","lSTS","rpLOC","lLOC","rLOC","PCC"))
...
tiff("NPS_d_within_pain_subregions.tiff",units="in",width = 12,height = 8,res = 300)

...
#
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_ICC_exclude_nsf.csv'
...
abline(v = 30, col = "grey",lty = 2, lwd = 3)
...
# dot of RTNF
points(x=15, y = 0.75, col = "#BF7FBA", pch = 16,cex=6)
#text(locator(), labels = "RTNF")
# dot of OLP4CBP
points(x=2.5, y = 0.46, col = "#96AFCC", pch = 16,cex=6)

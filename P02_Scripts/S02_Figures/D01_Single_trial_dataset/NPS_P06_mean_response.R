...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_mean_response.csv'
...
tiff("NPS_mean_response.tiff",units="in",width = 8,height = 5,res = 300)

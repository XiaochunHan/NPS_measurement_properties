...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_within_r_pain.csv'
...
tiff("NPS_within_r_pain.tiff",units="in",width = 8,height = 5,res = 300)

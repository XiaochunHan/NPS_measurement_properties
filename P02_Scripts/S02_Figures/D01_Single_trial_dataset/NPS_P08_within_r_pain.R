...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_within_r_pain_exclude_nsf.csv'
my_data = read.csv(file,header=TRUE)

# colors settings
# col=c("#D19640", "#D19640", "#D19640", "#D19640", "#D19640", "#D19640", "#D19640", "#D19640", "#D19640")
col=c("#D19640", "#D19640", "#D19640", "#D19640", "#D19640", "#D19640", "#D19640", "#D19640")
...
tiff("NPS_within_r_pain_exclude_nsf.tiff",units="in",width = 8,height = 5,res = 300)
p<-ggplot(my_data,aes(x=study,y=within_r_pain, colour = rgb(209/255,150/255,64/255))) + geom_hline(yintercept=0,size=0.5,linetype = "dashed")

...
#
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/rating_ICC.csv'
...
# dot of RTNF
points(x=15, y = 0.86, col = "#BF7FBA", pch = 16,cex=4)
text(locator(), labels = "RTNF")
# dot of OLP4CBP
points(x=2.5, y = 0.26, col = "#96AFCC", pch = 16,cex=4)
...
tiff("Rating_ICC_by_trial.tiff",units="in",width = 8,height = 12,res = 300)
dev.off()

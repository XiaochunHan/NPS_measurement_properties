...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/Four_effect_size.csv'
...
Org <- data.frame(matrix(nrow = 36))
Org$brain<-rep(c("Mean","inTemp","inPain","betPain"),each = 9)
...
tiff("NPS_four_effect_size.tiff",units="in",width = 9,height = 8,res = 300)

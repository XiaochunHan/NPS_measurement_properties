...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/Four_effect_size_exclude_nsf.csv'
...
tiff("NPS_four_effect_size_exclude_nsf.tiff",units="in",width = 9,height = 8,res = 300)

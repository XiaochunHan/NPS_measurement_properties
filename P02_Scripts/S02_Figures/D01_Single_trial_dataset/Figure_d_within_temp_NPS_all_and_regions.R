...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_local_within_temp_effect_size.csv'
...
Org$brain <- factor(Org$brain, level = c("NPS","rIns","dACC","rdpIns","lIns","rS2","rThal","vermis","rV1","rIPL","lSTS","pgACC","rLOC","rpLOC","lLOC","PCC"))
...
tiff("NPS_d_within_temp_subregions.tiff",units="in",width = 12,height = 8,res = 300)

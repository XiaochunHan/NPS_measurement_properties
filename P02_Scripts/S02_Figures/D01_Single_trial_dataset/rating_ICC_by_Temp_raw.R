...
#
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/rating_ICC_temp.csv'
Data = read.csv(file,header=TRUE)

setwd('/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/Manuscript/Figures')
tiff("Rating_ICC_by_temp.tiff",units="in",width = 10,height = 12,res = 300)
x = Data$temp
# bmrk3 ICC

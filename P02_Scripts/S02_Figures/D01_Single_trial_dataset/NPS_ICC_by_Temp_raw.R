...
#
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_ICC_temp.csv'
...
plot(data, frame.plot=FALSE, xlab="temperature", ylab="ICC", col=alpha(col[1],0.4), lwd=1.5, xlim = c(45,50), ylim=c(0.4,1), pch = 19, cex = 2, yaxt='n')
...
points(data, col=alpha(col[2],0.4), lwd=1.5, pch = 19,cex=2)
...
points(data, col=alpha(col[3],0.4), lwd=1.5, pch = 19,cex=2)
...
points(data, col=alpha(col[5],0.4), lwd=1.5, pch = 19,cex=2)
...
points(data, col=alpha(col[6],0.4), lwd=1.5, pch = 19,cex=2)
...
points(data, col=alpha(col[9],0.4), lwd=1.5, pch = 19,cex=2)

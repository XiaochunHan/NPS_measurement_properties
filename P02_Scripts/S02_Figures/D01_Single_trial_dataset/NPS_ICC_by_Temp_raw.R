...
#
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_ICC_temp_exclude_nsf.csv'
Data = read.csv(file,header=TRUE)

setwd('/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/Manuscript/Figures')
tiff("NPS_ICC_by_temp_exclude_nsf.tiff",units="in",width = 10,height = 12,res = 300)
x = Data$temp
# bmrk3 ICC
...
plot(data, frame.plot=FALSE, xlab="temperature", ylab="ICC", col=alpha(col[1],0.4), lwd=1.5, xlim = c(45,50), ylim=c(0.4,1), pch = 19, cex = 3, yaxt='n')
axis(side = 2, at=c(0.4,0.6,0.75,1))
#lines(x.bmrk3, plx.bmrk3$y, col=alpha(col[1],0.3), lwd=3)
lines(x.bmrk3, y.bmrk3, col=alpha(col[1],0.8), lwd=3)
...
points(data, col=alpha(col[2],0.4), lwd=1.5, pch = 19,cex=3)
#lines(x.bmrk4, plx.bmrk4$y, col=alpha(col[2],0.3), lwd=3)
lines(x.bmrk4, y.bmrk4, col=alpha(col[2],0.8), lwd=3)
...
points(data, col=alpha(col[3],0.4), lwd=1.5, pch = 19,cex=3)
#lines(x.bmrk5,plx.bmrk5$y, col=alpha(col[3],0.3), lwd=3)
lines(x.bmrk5, y.bmrk5, col=alpha(col[3],0.8), lwd=3)
...
points(data, col=alpha(col[5],0.4), lwd=1.5, pch = 19,cex=3)
#lines(x.ie, plx.ie$y, col=alpha(col[5],0.3), lwd=3)
lines(x.ie, y.ie, col=alpha(col[5],0.8), lwd=3)
...
points(data, col=alpha(col[6],0.4), lwd=1.5, pch = 19,cex=3)
#lines(x.ie2, plx.ie2$y, col=alpha(col[6],0.3), lwd=3)
lines(x.ie2, y.ie2, col=alpha(col[6],0.8), lwd=3)
...
points(data, col=alpha(col[9],0.4), lwd=1.5, pch = 19,cex=3)
#lines(x.scebl, plx.scebl$y, col=alpha(col[9],0.3), lwd=3)
lines(x.scebl, y.scebl, col=alpha(col[9],0.8), lwd=3)
#text(locator(), labels = "9")

# add legend
#legend(x=49,y=0.55,c("1-bmrk3pain","2-bmrk4","3-bmrk5pain","5-ie","6-ie2","9-scebl"),bty = "n")
dev.off()

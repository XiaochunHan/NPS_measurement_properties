...
file = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_local_between_pain_effect_size.csv'
...
Org$brain <- factor(Org$brain, level = c("NPS","rdpIns","rIns","rThal","dACC","vermis","rS2","lIns","rV1","pgACC","rLOC","rpLOC","lLOC","lSTS","rIPL","PCC"))
...
tiff("NPS_d_between_pain_subregions.tiff",units="in",width = 12,height = 8,res = 300)

...
#
file_single = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_ICC_single.csv'
Data_single = read.csv(file_single,header=TRUE)
file_contrast = '/Users/spring/Dropbox (Dartmouth College)/NPS_Reliability/D01_Single_trial_dataset/behavior/NPS_ICC_contrast.csv'
...
plot(data_single, frame.plot=FALSE, xlab="temperature", ylab="ICC", col=alpha(col[1],0.4), lwd=1.5, xlim = c(46,50), ylim=c(0,1), pch = 19, cex = 3, yaxt='n')
axis(side = 2, at=c(-1,0,0.4,0.6,0.75,1))
points(data_contrast, col=alpha(col[1],0.4), lwd=1.5, pch = 19,cex=1.5)
...
points(data_single, col=alpha(col[2],0.4), lwd=1.5, pch = 19,cex=3)
points(data_contrast, col=alpha(col[2],0.4), lwd=1.5, pch = 19,cex=1.5)
...
points(data_single, col=alpha(col[3],0.4), lwd=1.5, pch = 19,cex=3)
points(data_contrast, col=alpha(col[3],0.4), lwd=1.5, pch = 19,cex=1.5)
...
points(data_single, col=alpha(col[5],0.4), lwd=1.5, pch = 19,cex=3)
points(data_contrast, col=alpha(col[5],0.4), lwd=1.5, pch = 19,cex=1.5)
...
points(data_single, col=alpha(col[6],0.4), lwd=1.5, pch = 19,cex=3)
points(data_contrast, col=alpha(col[6],0.4), lwd=1.5, pch = 19,cex=1.5)
...
points(data_single, col=alpha(col[9],0.4), lwd=1.5, pch = 19,cex=3)
points(data_contrast, col=alpha(col[9],0.4), lwd=1.5, pch = 19,cex=1.5)

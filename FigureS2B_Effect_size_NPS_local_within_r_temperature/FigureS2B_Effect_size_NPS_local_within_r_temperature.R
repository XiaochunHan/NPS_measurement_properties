...
# setwd('./FigureS2B_Effect_size_NPS_within_r_temperature')

file = 'NPS_local_within_temp_effect_size.csv'
...
Org$brain <- factor(Org$brain, level = c("nps","pos_rIns","pos_dACC","pos_rdpIns","pos_lIns","pos_rS2","pos_rThal","pos_vermis","pos_rV1","neg_rIPL","neg_lSTS","neg_pgACC","neg_rLOC","neg_rpLOC","neg_lLOC","neg_PCC"))

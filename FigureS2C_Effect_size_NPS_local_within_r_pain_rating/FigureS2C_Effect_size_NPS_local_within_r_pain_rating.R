...
# setwd('./FigureS2C_Effect_size_NPS_local_within_r_pain_rating')
file = 'NPS_local_within_pain_effect_size.csv'
...
Org <- order_data %>% gather(brain, d, nps:neg_PCC)
Org$brain <- factor(Org$brain, level = c("nps","pos_dACC","pos_rIns","pos_lIns","pos_rdpIns","pos_rThal","pos_rS2","pos_vermis","pos_rV1","neg_rIPL","neg_pgACC","neg_lSTS","neg_rpLOC","neg_lLOC","neg_rLOC","neg_PCC"))

...
plot(data, type = "n", frame.plot=FALSE, xlab="Trial Number", ylab="ICC", col=alpha(col[1],0.4), lwd=1.5, xlim = c(1,40), ylim=c(0,1), pch = 1, yaxt='n')
...
# dot of RTNF
points(x=15, y = 0.73, col = "#BF7FBA", pch = 16,cex=5)

# dot of OLP4CBP
points(x=2.5, y = 0.46, col = "#96AFCC", pch = 16,cex=5)
